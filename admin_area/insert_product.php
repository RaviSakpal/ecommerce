...
<html>
    ...
    <body bgcolor="#a9a9a9">
        ...
        <form action="insert_product.php" method="post" enctype="multipart/form-data">
            ...
            <table align="center" width="700" border="2" bgcolor="#d3d3d3">
...
<?php
    if(isset($_POST['insert_post'])){
        ...
        $insert_product = "INSERT INTO products(product_cat,product_brand,"
                ...
                . "product_keywords)values('$product_cat','$product_brand',"
                . "'$product_title','$product_price','$product_desc','$product_image',"
                . "'$product_keywords')";
        
        $insert_pro = mysqli_query($con, $insert_product);

        echo "after allocating insert_pro";


        if($insert_pro){

            echo "before if script ";
            
            echo "<script>alert('Product has been inserted!')</script>";
            echo "<script>window.open('insert_product.php', '_self')</script>";

            echo "after if script ";
        }
